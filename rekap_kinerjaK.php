  ...
  <div class="content-wrapper">
    <div class="row mb-4">
      <div class="col-12 col-xl-8">
        <h3 class="font-weight-bold">Rekap Kinerja Bulanan AO <?= htmlspecialchars($_SESSION['kode_cabang']) ?></h3>
      </div>
    </div>
    ...
    <?php if (!empty($kode_cabang) && $bulan && $tahun): ?>
      ...
      <table class="table table-hover table-bordered" id="dataTables-example" width="100%">
        <thead class="thead-light table-primary">
          <tr>
            ...
            <th>CKPN</th>
            <th>Konfirmasi (1)</th>
            <th>Alamat Baru Belum Ditemukan (2)</th>
        ...
        if ($stmt = $mysqli->prepare($query)) {
            $stmt->bind_param("iiss", $bulan, $tahun, $kode_cabang, $kode_cabang);
            $stmt->execute();
        ...
        <tr>
          ...
          <td class="text-center"><?= htmlspecialchars($bulan_input) ?></td>
